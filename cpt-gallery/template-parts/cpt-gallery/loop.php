        ...
        while (have_posts()) : the_post(); ?>
            ...
            <div class="vehicle-item animate fade-in-up <?php echo tsc_set_vehicle_sold($vehicle['price_category']); ?>">
                <div class="vehicle-image-wrapper">
                    <a href=" <?php the_permalink(); ?>" class="vehicle-image-link">
                        <?php
                ...
                <?php echo get_the_term_list(get_the_ID(), 'vehicles_status_category', '<span class="categories">', ', ', '</span>'); ?>
                ...
                <p class="vehicle-price <?php if ($vehicle['price_category'] == 5): echo 'sold'; endif; ?>">
                    <?php echo tsc_get_vehicle_price_per_cat($vehicle['price_category'], $vehicle['price']); ?>
                </p>

                <?php if ($vehicle['price_category'] != 5): ?>
                    <div class="teaser-button txt-center">
                        <a class="btn-secondary" href="<?php echo get_the_permalink() . '/#contact-form'; ?>">
                            <?php _e('Fotos ansehen', 'ize'); ?>
                        </a>
                    </div>
                <?php endif; ?>
